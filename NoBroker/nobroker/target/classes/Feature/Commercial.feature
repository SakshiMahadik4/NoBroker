...
#    Then the user should be navigated to the commercial properties section
 ...
 Scenario: Search commercial properties in Hinjewadi
  Given the user is on the NoBroker website homepage
  When the user clicks on the "Commercial" tab
  And the user switches city to Pune from the dropdown
  And the user enters "Hinjewadi" in the location field
  And the user clicks the search button
  Then the user should see search results for "Hinjewadi"
